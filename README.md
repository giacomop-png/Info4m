...
No primeiro arquivo, o Conexao.php funciona como ponte para a conexão com o banco de dados, exigindo dados como o nome de usuário, a senha, database e host.
